      ...
      <>
        <SkillsBlock additionalStyles={styles.SQLSkillsBlock}>
          <ul className={`${styles.unorderedList} ${styles.mainUnorderedList}`}>
            <li className={`${styles.listElement} ${styles.firstListElement}`}><div className={`${styles.listElementContainer} ${styles.firstListElementContainer}`} onClick={(event) => showModal(event)}><SkillBar progressPercentage='65'>{tech.SQL}</SkillBar></div>
              <ul className={styles.unorderedList}>
                <li className={styles.listElement}><div className={styles.listElementContainer} onClick={(event) => showModal(event)}><SkillBar progressPercentage='80'>{tech.NODEJS}</SkillBar></div>
                  <ul className={styles.unorderedList}>
                    <li className={styles.listElement}><div className={styles.listElementContainer} onClick={(event) => showModal(event)}><SkillBar progressPercentage='70'>{tech.EXPRESS}</SkillBar></div></li>
                    <li className={styles.listElement}><div className={styles.listElementContainer} onClick={(event) => showModal(event)}><SkillBar progressPercentage='65'>{tech.SEQUELIZE}</SkillBar></div></li>
                  </ul>
                </li>
              </ul>
            </li>
        ...
        <SkillsBlock additionalStyles={styles.NoSQLSkillsBlock}>
          <ul className={`${styles.unorderedList} ${styles.mainUnorderedList}`}>
            <li className={`${styles.listElement} ${styles.firstListElement}`}><div className={`${styles.listElementContainer} ${styles.firstListElementContainer}`} onClick={(event) => showModal(event)}><SkillBar progressPercentage='65'>{tech.NOSQL}</SkillBar></div>
              <ul className={styles.unorderedList}>
                <li className={styles.listElement}><div className={styles.listElementContainer} onClick={(event) => showModal(event)}><SkillBar progressPercentage='80'>{tech.NODEJS}</SkillBar></div>
                  <ul className={styles.unorderedList}>
                    <li className={styles.listElement}><div className={styles.listElementContainer} onClick={(event) => showModal(event)}><SkillBar progressPercentage='70'>{tech.EXPRESS}</SkillBar></div></li>
                    <li className={styles.listElement}><div className={styles.listElementContainer} onClick={(event) => showModal(event)}><SkillBar progressPercentage='65'>{tech.MONGOOSE}</SkillBar></div></li>
                  </ul>
                </li>
              </ul>
            </li>
