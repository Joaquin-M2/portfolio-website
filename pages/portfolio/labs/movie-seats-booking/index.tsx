...
import MoviesContainer from '../../../../components/labs/movie-seats-booking/movies-container/movies-container';
import SeatsLegend from '../../../../components/labs/movie-seats-booking/seats-legend/seats-legend';
import CinemaRoom from '../../../../components/labs/movie-seats-booking/cinema-room/cinema-room';
import SeatsBookingMessage from '../../../../components/labs/movie-seats-booking/seats-booking-message/seats-booking-message';

import TonguesContainer from '../../../../components/common/tongues-container/tonguesContainer';

const MovieSeatsBookingLab: React.FC = () => {
    ...
    return (
        <>
            <Head>
                <title>Portfolio JM2: Labs - Movie Seats Booking</title>
...
export default MovieSeatsBookingLab;
