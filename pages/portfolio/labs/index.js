...
import PortfolioFiltersBar from '../../../components/projects/portfolio-website/pf-filters-bar/pf-filters-bar';
import NavBarTopButton from '../../../components/projects/portfolio-website/nav-bar-top/nav-bar-top';
import PortfolioSlider from '../../../components/projects/portfolio-website/pf-slider/pf-slider';

import PortfolioSliderThumbnailsContainer from '../../../components/projects/portfolio-website/pf-slider/pf-slider-thumbnails-container/pf-slider-thumbnails-container';
import MoveSlideButton from '../../../components/projects/portfolio-website/pf-slider/pf-move-slide-button/pf-move-slide-button';
import PortfolioSliderThumbnail from '../../../components/projects/portfolio-website/pf-slider/pf-slider-thumbnails-container/pf-slider-thumbnail/pf-slider-thumbnail';
...
export default function Labs() {
    ...
    for (const project of projects) {
        if (
            ...
            activeFilters.every((filtro) =>
                project.technologies.includes(filtro)
            )
        ) {
            thumbnails.push(
    ...
    useEffect(() => {
        if (
            !thumbnails.some(
                (thumbnail) => thumbnail.props.id === activeThumbnail
            )
        ) {
    ...
    return (
        <>
            <Head>
                <title>Portfolio: Labs - JM2</title>
            ...
            <div className={styles.SupraMainContainer}>
                <main className={styles.MainContainer}>
                    ...
                    <div className={styles.NoFiltersContainer}>
                        <nav
                            className={styles.NextToFiltersContainer_TopNavBar}
                        >
                            <NavBarTopButton link="/portfolio/projects">
                                Projects
                            </NavBarTopButton>
                            <NavBarTopButton link="/portfolio/labs">
                                Labs
                            </NavBarTopButton>
                        </nav>
                        <div
                        ...
                        >
                            ...
                            <PortfolioSlider
                                ...
                                checkTheCode={
                                    projects[currentSelectedProject].linkToCode
                                }
                                checkTheProject={
                                    projects[currentSelectedProject]
                                        .linkToProject
                                }
