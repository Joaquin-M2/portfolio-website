    ...
    <>
      ...
      <aside className={`${styles.Container} ${props.additionalStyles}`}>
        ...
        <ul className={styles.List}>
          <Link legacyBehavior href='/web-development-notes/javascript'>
            <a
              className={`${styles.ListElement} ${
                router.pathname.startsWith('/web-development-notes/javascript')
                  ? styles.active
                  : null
              }`}
            >
          ...
          <Link legacyBehavior href='/web-development-notes/typescript'>
            <a
              className={`${styles.ListElement} ${
                router.pathname.startsWith('/web-development-notes/typescript')
                  ? styles.active
                  : null
              }`}
            >
          ...
          <Link legacyBehavior href='/web-development-notes/react'>
            <a
              className={`${styles.ListElement} ${
                router.pathname.startsWith('/web-development-notes/react')
                  ? styles.active
                  : null
              }`}
            >
          ...
          <Link legacyBehavior href='/web-development-notes/html'>
            <a
              className={`${styles.ListElement} ${
                router.pathname.startsWith('/web-development-notes/html')
                  ? styles.active
                  : null
              }`}
            >
          ...
          <Link legacyBehavior href='/web-development-notes/css'>
            <a
              className={`${styles.ListElement} ${
                router.pathname.startsWith('/web-development-notes/css')
                  ? styles.active
                  : null
              }`}
            >
