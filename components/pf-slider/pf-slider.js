...
export default function PortfolioSlider(props) {
    ...
    useEffect(() => {
        ...
        function dragStart (e) {
            ...
            slider.current.classList.remove(appearNewSlideCSSFromRight, appearNewSlideCSSFromLeft);
        }

        function dragAction (e) {
            e = e || window.event;
            pageXCoords.push(e.touches[0].pageX);
            slider.current.style.transform = `translateX(${(posInitial - e.touches[0].pageX) * -1}px)`;
        }
    ...
    return (
        <>
            <div className={`${styles.Slider} ${props.additionalStyles}`}
                 ref={slider}
            ...
            >
                <div className={styles.ImageContainer}>
                    ...
                    <input className={styles.CurtainCheckbox} type="checkbox" id="curtain" name="slider-curtain" />
                    ...
                    <div className={styles.Curtain}>
                        ...
                        <a className={styles.CurtainDetails_CheckCodeLink} 
                           href={props.checkTheCode} 
                           target="_blank" 
                           rel="noopener noreferrer">
                            {">>"} Click here to check the code {"<<"}
                            {/* <svg className={styles.CurtainDetails_GitHub}>
                                <use href="sprites.svg#icon-github"></use>
                            </svg> */}
                        </a>
                    </div>
                    {/* <div className={styles.Curtain}>
                        <div className={styles.CurtainButton}></div>
                    </div> */}
                </div>
