...
export default function ContactForm() {
    ...
    input.current.childNodes[0].classList.remove(styles.ContactFormInputSuccess);
    ...
    function checkNameField() {
      if (nameInput.current.childNodes[0].value.trim() === '') {
        ...
        showError(
          nameInput,
          'Your name needs to be longer than 2 characters'
        );
      } else if (nameInput.current.childNodes[0].value.length > 21) {
        showError(
          nameInput,
          'Your name needs to be shorter than 20 characters'
        );
      } else {
    ...
    // Init a timeout variable to be used below
      ...
      function activateFormButtonHandler() {
        ...
        // Make a new timeout set
        timeout = setTimeout(() => {
          if (nameInput.current.childNodes[0].value.length > 2 && 
    ...
    return (
        ...
        >
            ...
            <div className={styles.FormField} ref={nameInput}>
                ...
                required 
                />
                <label className={styles.ContactFormLabel} htmlFor="name-input">Your name</label>
                <small></small>
            </div>
            <div className={styles.FormField} ref={emailInput}>
                ...
                required 
                />
                <label className={styles.ContactFormLabel} htmlFor="email-input">Your email</label>
                <small></small>
            </div>
            <div className={styles.FormField} ref={reasonInput}>
                ...
                required
                />
                <label className={styles.ContactFormLabel} htmlFor="reason-input">Reason</label>
                <small></small>
            ...
            <div className={styles.FormField} ref={messageInput}>
                ...
                required
                ></textarea>
                <label className={styles.ContactFormLabel} htmlFor="textarea-input">Your message</label>
                <small></small>
            </div>
